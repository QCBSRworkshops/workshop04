...
Pour une ANOVA où la variable prédictrice est catégorique, The intercept is the baseline group and corresponds to the mean of the first (alphabetically) level. By calculating the intercept and coefficient estimates of each `Diet` level, *What did you notice*? 
