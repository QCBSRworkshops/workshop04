...
the level (MS~Trt~) on the mean sum of squares of the error (MS~E~).
...
replicates per level; $overline{y}\</m\>: general mean of the
explanatory variable; $overline{y}\</m\>~i~ : mean of the
explanatory variable for all the replicates of the level i.
