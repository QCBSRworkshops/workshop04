...
Diet level. We can use only these graph to verify our assumptions, however, we can also use the Shapiro's, Bartlett's tests or Levene's test. **Note**:Levene's test performs better, but has a slightly higher Type II error.
...
The Shapiro and Bartlett tests are both non-significant,
