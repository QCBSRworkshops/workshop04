...
# add text mean
mtext(expression(mu[1]), 1, at = x[posList[[1]][3]], line = -12, cex = 2)
mtext(expression(mu[2]), 1, at = x[posList[[2]][3]], line = -12, cex = 2)
mtext(expression(mu[3]), 1, at = x[posList[[3]][3]], line = -12, cex = 2)
...
mtext('Between-group variance', at = 10.25, line = -1.5, cex = 1.4)
mtext('Within-group variance', 1, at = x[posList[[3]][3]], line = 0.3, cex = 1.4, col = colorBlind[3])
