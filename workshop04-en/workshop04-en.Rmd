...
.comment[Mathematical notations are not usually used within R. For example in mathematical notation, *x* represents the population. In R, *X* usually represents an object to be use in a formula, or an axis when making plots.]
