...
.comment[Les notations mathémathiques sont rarement utilisées dans R et sont souvent différentes. Par  exemple, en mathématique, *x* représente la population à l'étude. Dans R, *X* représente habituellement un objec en utilisation au sein d'une fonction, ou fait référence à un axe d'un graphique. Faites attention de bein comprendre la notation utilisée lorsque vous roulez une fonction.]
