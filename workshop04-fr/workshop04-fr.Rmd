...
cat(
  qcbsRworkshops::first_slides(4, c('dplyr', 'vegan', 'e1071', 'MASS', 'car'), lang = "fr")
)
```
...
### Utiliser `lm()` pour faire un modèle linéaire avec R

### Utiliser `anova()` pour réaliser une analyse de variance avec R
...
- Prendre le temps d'expliquer les résultat de `summary()` :
...
---
# Et si les suppositions ne sont pas respectées...
